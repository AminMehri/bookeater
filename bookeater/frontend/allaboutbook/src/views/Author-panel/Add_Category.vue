    ...
    <div class="row g-0">
        ...
        <div class="col-sm-8 col-md-9 col-lg-10 p-3 mt-3">
            ...
            <div class="row g-3 border p-4">
                ...
                <div class="col-md-6">
                    <label for="id_category" class="form-label ms-3">نویسنده های مرتبط:</label>
                    <select name="category" required="" id="id_category" multiple="">

                        <option value="2" selected="">یالوم</option>
                        <option value="1">نیچه</option>
                        <option value="3">یوستین گوردر</option>
